...
if __name__ == '__main__':
    oper = OperationExcel('./test.xls')
    oper1 = OperationExcel('./test1.xls')
    oper2 = OperationExcel('./test2.xls')
    data = oper.read_excel_data()
    data1 = oper1.read_excel_data()
    data3 = oper.get_data_for_dict()
    print(data3)
    list_res = []
    list_res1 = []
    for i in data:
